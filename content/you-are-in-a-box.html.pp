#lang pollen
◊(define title "you are in a box")
◊(define date "2025-07-14")
◊(define description "your data is trapped inside the box that is your program. you can only see what the program author exposes.")
◊(define taxonomies (hash "tags" '("ideas") "computer-of-the-future" '("1")))
◊(define extra (hash "category" "principles" "toc" ""))
