...
; https://github.com/babashka/http-server/blob/7259ab93400c18afc90afcf2cfe82aaa2064e6a1/src/babashka/http_server.clj
; this is forked to support custom 404 pages; see https://github.com/babashka/http-server/issues/21

;; Based on https://gist.github.com/holyjak/36c6284c047ffb7573e8a34399de27d8
;; Based on https://github.com/babashka/babashka/blob/master/examples/image_viewer.clj
(ns flower.http-server
  ...
  (fn [{:keys [uri] :as req}]
    (let [f (fs/path dir (str/replace-first (URLDecoder/decode uri) #"^/" ""))
      ...
      (update (cond
                ...
                :else
                (merge (body (fs/path dir "404.html")) {:status 404}))
